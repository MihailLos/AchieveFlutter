...
import 'package:achieve_student_flutter/screens/pgas/new_pgas_request_viewmodel.dart';
...
class NewPgasRequestScreen extends StatelessWidget {
  ...
  _surnameTextField(context, NewPgasRequestViewModel model) {
    return Row(
  ...
  _firstNameTextField(context, NewPgasRequestViewModel model) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        SizedBox(
  ...
  _middleNameTextField(context, NewPgasRequestViewModel model) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        SizedBox(
  ...
  _phoneTextField(context, NewPgasRequestViewModel model) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        SizedBox(
  ...
  _groupTextField(context, NewPgasRequestViewModel model) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        SizedBox(
  ...
  _title(context) {
    return Text("Новая заявка на ПГАС",
        style: CyrillicFonts.raleway(
            fontSize: 24,
